...
<div class="wrapper">
    <div id="header">
        <h1><a href="index.php">Cowrie-Graph</a></h1>
        <br/>

        <p>Fast Visualization for your Cowrie SSH Honeypot Stats</p>
    </div>
</div>
<!-- ####################################################################################################### -->
<div class="wrapper">
    <div id="topbar">
        <div class="fl_left">Version: 1.5.1 | Website: <a href="http://bruteforce.gr/kippo-graph">Here</a>
        </div>
        <br class="clear"/>
    </div>
</div>
...
<div class="wrapper">
    <div id="topnav">
        <ul class="nav">
            ...
            <li><a href="kippo-graph.php">Graph</a></li>
            <li><a href="kippo-input.php">Input</a></li>
            <li><a href="kippo-playlog.php">PlayLog</a></li>
            <li><a href="kippo-ip.php">IPs</a></li>
            <li><a href="kippo-geo.php">Geo</a></li>
...
<div class="wrapper">
    <div class="container">
        <div class="whitebox">
            <!-- ####################################################################################################### -->
            <h3>Leave this please, intruder!</h3>
...
<div class="wrapper">
    <div id="copyright">
        <p class="fl_left">Copyright &copy; 2011 - 2015 - All Rights Reserved - <a
                href="http://bruteforce.gr/kippo-graph">Cowrie-Graph</a></p>
