			...
			<div class="register-box">
				<form class="modal-content animate"  method="post" action="submit.php">
					<table>
						<tr>
							<td><p>Nombre</p></td>
							<td><input type="text" placeholder="Nombre" name="name" required/></td>
						</tr>
						<tr>
							<td><p>Email</p></td>
						...
						<tr>
							...
							<td><input type="password" placeholder="" name="pass1" required/></td>
						</tr>
						<tr>
							<td><p>Confirmar contraseña</p></td>
							<td><input type="password" placeholder="" name="pass2" required/></td>
						</tr>
						<tr>
							<td><button type="submit" value="Ingresar">Registrarse</button></td>
						</tr>
					</table>
				</form>
			</div>
